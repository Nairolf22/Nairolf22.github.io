...
{% for review in site.reviews %}
    ...
    {% comment %} Sortierreihenfolge: Kulisse > Atmo > Rätsel > GM > Story > Datum {% endcomment %}
    {% capture key %}{{ s_scen }}-{{ s_atmo }}-{{ s_puzz }}-{{ s_gm }}-{{ s_story }}-{{ s_date }}::{{ review.url }}{% endcapture %}
...
<div class="review-dossier">
    ...
    <div class="dossier-header">
        <h2 style="border-bottom: none; margin-bottom: 0;">Die Hall of Fame der Kulisse</h2>
        <p style="font-family: 'Courier New'; color: #666; margin-top: 0; font-size: 0.9rem;">
            // TOP 5 RANKING: SET-DESIGN & AUSSTATTUNG
        </p>
    </div>
    ...
    <div style="font-family: 'Courier New', monospace; line-height: 1.6; color: #333;">
        ...
        <div style="background: rgba(0,0,0,0.03); padding: 20px; border-left: 5px solid var(--rust-primary); margin-bottom: 3rem;">
            <h3 style="margin-top: 0; text-transform: uppercase;">Das Auge spielt mit</h3>
            <p>
                Vorbei sind die Zeiten von bemalten Spanplatten und Baumarkt-Regalen. In dieser Kategorie ehren wir die "Hollywood-Sets" unter den Escape Rooms.
            </p>
            <p>
                Wir suchen nach Räumen, die uns visuell überwältigen. Wo jeder Gegenstand authentisch wirkt, die Materialien echt sind und die Lichtstimmung perfekt gesetzt ist. Wenn wir uns fühlen wie in einem Blockbuster-Filmset oder einer echten Ruine, dann landet der Raum auf dieser Liste.
            </p>
        </div>
