...
<div class="review-dossier" style="font-family: 'Courier New', Courier, 'Lucida Sans Typewriter', 'Lucida Typewriter', monospace; line-height: 1.6; color: #333;">
    ...
    <div>
        ...
        Die Datenerfassung auf dieser Website erfolgt durch den Websitebetreiber, den Hostinganbieter GitHub und den Analysedienst GoatCounter. Die Details entnehmen Sie den folgenden Abschnitten.</p>
        ...
        <h3 style="color: var(--rust-primary, #a0522d); margin-top: 30px;">4. Datenerfassung und Analyse</h3>
        ...
        Diese Website verwendet <strong>keine Cookies</strong>. Es werden keine Daten auf Ihrem Endgerät gespeichert, die eine Identifizierung oder Nachverfolgung über Sitzungen hinweg ermöglichen.</p>

        <p><strong>Webanalyse mit GoatCounter</strong><br>
        Um zu sehen, welche unserer Akten (Seiten) am beliebtesten sind, nutzen wir den Dienst <strong>GoatCounter</strong>. Dieser Dienst ist besonders datenschutzfreundlich (Privacy-Friendly Analytics) und trackt keine individuellen Besucher:</p>
        <ul style="list-style-type: square;">
            <li>Es werden <strong>keine Cookies</strong> gesetzt.</li>
            <li>Es werden <strong>keine persönlichen Daten</strong> gespeichert.</li>
            <li>Ihre IP-Adresse wird nur anonymisiert verarbeitet, um die Gesamtzahl der Besucher zu ermitteln, und nicht dauerhaft gespeichert.</li>
            <li>Es findet keine Weitergabe von Daten an Werbenetzwerke oder Dritte (wie Google) statt.</li>
        </ul>
